...
import { keyboardCommand, SHORTCUTS } from './shared/keyboard';
export default function KeyboardHelp() {
  const { help, setHelp, navigate, setEditing, undo, redo } = useWorkshop();
  useEffect(() => {
  ...
  }, [navigate, setEditing, setHelp, undo, redo]);
  return (
    <section className="keyboard-help">
      ...
      {help && (
        <div className="panel">
          ...
          <p>Single-key shortcuts are inactive while editing a text field.</p>
          <dl>
