...
import { exportCsv, csvFilename } from '../../workshop/shared/csv-export';
import { exportSnapshot } from '../../workshop/shared/snapshot-export';
...
export class ExportComponent {
  ...
  csv(): void {
    downloadText(
      exportCsv(filterTasks(this.s.state, this.s.filters)),
  ...
  snapshot(): void {
    downloadText(
      exportSnapshot(this.s.state, new Date().toISOString()),
