...
import { sortTasks, SortKey, SortDirection } from '../../workshop/shared/sorting';
import { paginate } from '../../workshop/shared/pagination';
...
export class TaskTableComponent {
  ...
  change(key: SortKey): void {
    this.direction = this.key === key && this.direction === 'asc' ? 'desc' : 'asc';
    this.key = key;
  }
