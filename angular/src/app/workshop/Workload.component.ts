...
export class WorkloadComponent { constructor(public s:WorkshopStore) {}
get members(){return memberWorkload(this.s.state);}get unassigned(){return unassignedWork(this.s.state);}
}
